            ...
            <div className="sendMsg">
                <h4>Send Us A Message</h4>
                    ...
                    <div className="contentContact">
                        <Button borderRadius="90px" colorScheme="teal" variant="solid" size="180px" className="contactBtn">Submit</Button>
                    </div>
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3> Address</h3>
                        <p>Shibpur,Narsingdi,Dhaka,Bangladesh</p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">+8801621956685</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">tanbirhasan235@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
